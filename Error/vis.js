...
function init(value) {
    plotVisualizations('scrubbed',value);
}

function plotVisualizations(db,value) {
...
function plotUfosByState(data) {
    ...
    //d3.select("#plot-2").select("*").remove();
    d3.select("#plot-1").html(".row-svg");
...
function plotUfosByYear(data) {
    ...
    //d3.select("#plot-1").select("*").remove();
    d3.select("#plot-1").html(".row-svg");
